...
export default function RefactoredProjectNotes({ initialNotes = [] }) {
    ...
    <div className="card">
      ...
      <div className="space-y-4">
        {categories.map(category => {
          ...
          return (
            <div key={category.id} className="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden transition-shadow duration-200 hover:shadow-soft">
              <button
                className={`w-full flex justify-between items-center p-3.5 ${category.bgColor} hover:bg-opacity-80 dark:hover:bg-opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200`}
                ...
                <div>
                  <label className="block mb-1.5 font-medium text-gray-700 dark:text-gray-300">
                    ...
                    <textarea
                      ...
                      className="w-full h-48 p-3 mt-1.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-100 resize-none"
